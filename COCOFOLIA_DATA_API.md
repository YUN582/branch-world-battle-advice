...
```js
{
  ...
  closed: false,                     // ★ 비공개 상태 (true = 비공개/자신만보기)
  withoutOwner: false,               // ★ 자신 외 공개 (true = 소유자만 안 보임)
  // ── 공개 상태 필드 매핑 (2025-06 진단 확인) ──
  // 전체 공개: closed=false, withoutOwner=false, owner=null, ownerName=null
  // 비공개:   closed=true (only)
  // 자신만보기: closed=true, owner=uid, ownerName=speakingCharName
  // 자신외공개: withoutOwner=true (only)
